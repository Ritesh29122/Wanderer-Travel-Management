...
public class Home extends JFrame{
    ...
    public Home(String username) {
        super("WANDERER YOUR TRAVEL GUIDE");
	this.username = username;
        setForeground(Color.CYAN);
        setLayout(null); 

        
        ImageIcon i1 = new ImageIcon(System.getProperty("travel\\management\\system\\icons\\home.jpg"));
	...
	NewLabel.setBounds(0, 0, 1950, 1000); 
        ...
        JLabel l1 = new JLabel("WANDERER YOUR TRAVEL GUIDE");
